#rS.7.5.4.py module.
#MOD 7.5.4 #Stack was Loc(nme, ndx) now Loc(nme, lng) for length; allowing lng==0
...
Ppu = namedtuple('Pop',  'nme, fce, crd')  #Pop('T1', True, Crd('H', 12)) #MOD 7.5.4 avoid py  name conflict
