# stack.7.5.2.py module
# MOD 7.5.2     added moveMyItems() and DEPR moveItem()     added moveMyItems() and DEPR moveItem()
...
class Stack(list):
    ...
    def moveMyItems(self,  item,  to_stk):
        """ moves one or more items - a crd in  rS - from me to new stack.
