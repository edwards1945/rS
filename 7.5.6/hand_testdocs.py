...
class testHand:
    ...
    def test_sibMove(self):
        ...
        >>> newStt0.append(newStt('T6', False, sib_crd))   # faceDOWN sib violates RULE
    ...
    #def test_PLAY_1_Hand(self):
        ...
        #>>> from rS import *
        #>>> h = hand.Hand()
        #>>> testSetCntr = Counter(['wonCnt', 'fCnt', 'nCnt'])
        #>>>
