...
class State:
    ...
    def moveCrd2Nme(self,  mov2):  #MOD 7.5.4
        ...
        """
       #Mov2Nme handles updating crd2OD and crd.newStt; the call to frm_stk.moveMyItem() handles the stkOD updates.
        ...
        frm_stk.moveMyItems(crd, to_stk)  # >> crd now switched to 
        self.crd2OD[crd] = newStt(to_stk_nme,  True,  crd) 
        ...
        def build_full(self, shuffle ):
            ...
            for stk_nme,  fceL in STACK_FACE_DICT.items():
                ...
                for fce in  fceL:  #this is the pacer, the sync driver
                    ...
                    # REFACT old style new_stt =  Stt(Loc(stk,  stk.top_ndx), fce, crd)  # build new Stt
                    self.crd2OD[crd] =  new_stt  # want to crdD[crd] = new_stt
                    pass      
            pass
